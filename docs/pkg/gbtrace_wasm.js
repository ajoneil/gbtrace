...
export class TraceStore {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        TraceStoreFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * @returns {any}
     */
    entriesRange(start, count) {
        const ret = wasm.tracestore_entriesRange(this.__wbg_ptr, start, count);
        if (ret[2]) {
     ...
     */
    entry(index) {
        const ret = wasm.tracestore_entry(this.__wbg_ptr, index);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    entryCount() {
        const ret = wasm.tracestore_entryCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    fieldNames() {
        const ret = wasm.tracestore_fieldNames(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    constructor(data) {
        ...
        const ret = wasm.tracestore_from_bytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        TraceStoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    header() {
        const ret = wasm.tracestore_header(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    query(condition_str) {
        const ptr0 = passStringToWasm0(condition_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tracestore_query(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gbtrace_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
